...
class TabixIndexedVcfDatasourceTest(unittest.TestCase):
    ...
    def testESPAnnotationWithMissingSNP(self):
        ...
        m1_annotation = m1_annotated.getAnnotation("ESP_PP")
        cur_annotation = Annotation(value="", datasourceName="ESP", dataType="String", description="proteinPosition",
        ...
        m1_annotation = m1_annotated.getAnnotation("ESP_CG")
        cur_annotation = Annotation(value="", datasourceName="ESP", dataType="Float", description="consScoreGERP",
                                    tags=[TagConstants.INFO, TagConstants.NOT_SPLIT], number=1)
        self.assertTrue(m1_annotation.isEqual(cur_annotation), "Annotations do not match.")

        m1_annotation = m1_annotated.getAnnotation("ESP_MAF")
        cur_annotation = Annotation(value=",,", datasourceName="ESP", dataType="Float",
                                    description="Minor Allele Frequency in percent in the order of EA,AA,All",
    ...
    def testESPAnnotationWithExistingSNP(self):
        ...
        m1_annotated = tabixIndexedVcfDatasource.annotate_mutation(m1)
        m1_annotation = m1_annotated.getAnnotation("ESP_PP")
        cur_annotation = Annotation(value="168/306", datasourceName="ESP", dataType="String",
                                    description="proteinPosition", tags=[TagConstants.INFO, TagConstants.NOT_SPLIT],
                                    number=None)
        self.assertTrue(m1_annotation.isEqual(cur_annotation), "Annotations do not match.")

        m1_annotation = m1_annotated.getAnnotation("ESP_CG")
        cur_annotation = Annotation(value="-0.2", datasourceName="ESP", dataType="Float", description="consScoreGERP",
                                    tags=[TagConstants.INFO, TagConstants.NOT_SPLIT], number=1)
        self.assertTrue(m1_annotation.isEqual(cur_annotation), "Annotations do not match.")

        m1_annotation = m1_annotated.getAnnotation("ESP_MAF")
        cur_annotation = Annotation(value="0.0323,0.0,0.0205", datasourceName="ESP", dataType="Float",
                                    description="Minor Allele Frequency in percent in the order of EA,AA,All",
                                    tags=[TagConstants.INFO, TagConstants.NOT_SPLIT], number=3)
        self.assertTrue(m1_annotation.isEqual(cur_annotation), "Annotations do not match.")
    ...
    def testESPAnnotationWithExistingIndel(self):
        ...
        m1_annotated = tabixIndexedVcfDatasource.annotate_mutation(m1)
        m1_annotation = m1_annotated.getAnnotation("contrived_BC")
        cur_annotation = Annotation(value="101,201", datasourceName="contrived", dataType="Integer", description="B.C.",
                                    tags=[TagConstants.INFO, TagConstants.NOT_SPLIT], number=None)
        self.assertTrue(m1_annotation.isEqual(cur_annotation), "Annotations do not match.")

    def testAnnotatingWithMonomorphicDatabase(self):
