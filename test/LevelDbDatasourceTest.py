...
class LevelDbDatasourceTest(unittest.TestCase):
    pass
    ...
    #         h = LevelDbDatasource.generate_hash(m)
    #         if i % 5000 == 0:
    #             print("Rendering %d" % (i))
    #         try:
    ...
    #
    #     shove_ds = LevelDbDatasource(title="dbNSFP_chr1_test_" + protocol, version = "TEST", src_file=output_url, index_cols=index_cols)
