...
setup(
  ...
  test_suite='test',
  packages=['oncotator','oncotator.cache', 'oncotator.utils','oncotator.utils.install','oncotator.input','oncotator.output','oncotator.index','oncotator.configs', "oncotator.datasources"],
  license='''
# By downloading the PROGRAM you agree to the following terms of use:
#
# BROAD INSTITUTE SOFTWARE LICENSE AGREEMENT
